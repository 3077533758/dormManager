<template>
  <div>
    <el-breadcrumb separator-icon="ArrowRight" style="margin: 16px">
      ...
      <el-breadcrumb-item>外宿申请</el-breadcrumb-item>
    </el-breadcrumb>
    <el-card style="margin: 15px; min-height: calc(100vh - 111px)">
      <div>
        ...
        <div style="margin: 10px 0">
          <!--    搜索区-->
          <div style="margin: 10px 0">
            <el-input v-model="search" clearable placeholder="请输入学号或姓名" prefix-icon="Search" style="width: 20%"/>
...
<script src="@/assets/js/OutLiveInfo.js"></script> 