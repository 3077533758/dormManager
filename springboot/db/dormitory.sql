...
VALUES ('stu3', '吉安', 1101, 3, '转学', '通过', '2022-03-20 10:00:00', '2022-03-21 09:00:00');

INSERT INTO `quit_room` (`username`, `name`, `dormroom_id`, `bed_number`, `reason`, `state`, `apply_time`, `finish_time`)
VALUES ('stu6', '泡泡', 1102, 2, '搬出校外居住', '未处理', '2022-03-22 14:15:00', NULL);

INSERT INTO `quit_room` (`username`, `name`, `dormroom_id`, `bed_number`, `reason`, `state`, `apply_time`, `finish_time`)
VALUES ('stu11', '巧巧', 1103, 4, '家庭原因', '驳回', '2022-03-23 13:40:00', '2022-03-24 11:00:00');
...
CREATE TABLE `dorm_compound`  (
  `compound_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '围合ID',
  `compound_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '围合名称',
  `campus` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '所属园区',
  `compound_detail` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '围合备注',
...
-- ----------------------------
INSERT INTO `dorm_compound` VALUES (1, '一围合', '东园', '男生围合');
INSERT INTO `dorm_compound` VALUES (2, '二围合', '东园', '女生围合');
INSERT INTO `dorm_compound` VALUES (3, '三围合', '西园', '男生围合');
INSERT INTO `dorm_compound` VALUES (4, '四围合', '西园', '女生围合');
INSERT INTO `dorm_compound` VALUES (5, '五围合', '南园', '男生围合');
INSERT INTO `dorm_compound` VALUES (6, '六围合', '南园', '女生围合');
INSERT INTO `dorm_compound` VALUES (7, '七围合', '北园', '男生围合');
INSERT INTO `dorm_compound` VALUES (8, '八围合', '北园', '女生围合');
...
CREATE TABLE `dorm_build`  (
  ...
  `compound_id` int(0) NOT NULL COMMENT '所属围合ID',
...
-- ----------------------------
INSERT INTO `dorm_build` VALUES (1, '一号楼', '男宿舍', 1, '东园', 1);
INSERT INTO `dorm_build` VALUES (2, '二号楼', '女宿舍', 2, '东园', 2);
INSERT INTO `dorm_build` VALUES (3, '三号楼', '男宿舍', 3, '西园', 3);
INSERT INTO `dorm_build` VALUES (4, '四号楼', '女宿舍', 4, '西园', 4);
INSERT INTO `dorm_build` VALUES (5, '五号楼', '男宿舍', 5, '南园', 5);
INSERT INTO `dorm_build` VALUES (6, '六号楼', '女宿舍', 6, '南园', 6);
INSERT INTO `dorm_build` VALUES (7, '七号楼', '男宿舍', 7, '北园', 7);
INSERT INTO `dorm_build` VALUES (8, '八号楼', '女宿舍', 8, '北园', 8);
...
CREATE TABLE `dorm_manager`  (
  ...
  `compound_id` int(0) NULL DEFAULT NULL COMMENT '所管理的围合ID（围合宿管）',
  `manager_type` enum('楼栋宿管','围合宿管') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '楼栋宿管' COMMENT '宿管类型',
...
-- ----------------------------
INSERT INTO `dorm_manager` VALUES ('dorm1', '123456', 1, NULL, '楼栋宿管', '张三', '男', 35, '15995917873', NULL, NULL);
INSERT INTO `dorm_manager` VALUES ('dorm2', '123456', 2, NULL, '楼栋宿管', '李四', '女', 55, '15995917874', NULL, NULL);
INSERT INTO `dorm_manager` VALUES ('dorm3', '123456', 3, NULL, '楼栋宿管', '王五', '男', 38, '15896875201', NULL, NULL);
INSERT INTO `dorm_manager` VALUES ('dorm4', '123456', 4, NULL, '楼栋宿管', '赵花', '女', 40, '15877535247', NULL, NULL);
INSERT INTO `dorm_manager` VALUES ('dorm5', '123456', NULL, 1, '围合宿管', '陈六', '男', 42, '15995917875', NULL, NULL);
INSERT INTO `dorm_manager` VALUES ('dorm6', '123456', NULL, 2, '围合宿管', '孙七', '女', 45, '15995917876', NULL, NULL);
...
INSERT INTO `dorm_room` VALUES (3101, 3, 1, 4, 3, 'stu15', 'stu16', 'stu17', NULL);
...
INSERT INTO `repair` VALUES (7, '张三', 1, 1101, '阳台漏水', '阳台使用时会漏水请来修理', '未完成', '2022-03-14 20:37:35', NULL);
...
INSERT INTO `student` VALUES ('stu100', '123456', 18, '花花', '男', '12332143219', NULL, NULL);
INSERT INTO `student` VALUES ('stu101', '123456', 20, '小侯', '男', '15889658748', NULL, NULL);
-- ----------------------------
...
-- 插入示例数据 - 学生入住记录
-- ----------------------------
INSERT INTO `student_checkin` (`student_username`, `student_name`, `action_type`, `action_time`, `dormbuild_id`, `dormroom_id`, `bed_number`, `operator`, `remarks`) VALUES
('stu1', '张三', '入住', NOW(), 1, 1101, 1, 'admin', '普通入住'),
('stu2', '田田', '入住', NOW(), 1, 1101, 2, 'admin', '普通入住'),
('stu3', '吉安', '入住', NOW(), 1, 1102, 1, 'admin', '普通入住'),
('stu4', '力力', '入住', NOW(), 1, 1102, 2, 'admin', '普通入住'),
('stu5', '哦哦', '入住', NOW(), 1, 1103, 1, 'admin', '普通入住'),
('stu6', '泡泡', '入住', NOW(), 1, 1103, 2, 'admin', '普通入住');
...
CREATE TABLE `system_menu` (
  ...
  `menu_type` enum('菜单','按钮') DEFAULT '菜单' COMMENT '菜单类型',
...
CREATE TABLE `system_dict` (
  ...
  `dict_order` int DEFAULT 0 COMMENT '排序',
  `status` enum('启用','禁用') DEFAULT '启用' COMMENT '状态',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`),
...
(1103, 1, '2024-01-15', 12, 13, 14, 12, 13, 64, '中', '张三', '需要加强卫生管理');
...
(1102, 1, 'stu6', '泡泡', '宿舍吵闹', '深夜在宿舍大声喧哗', '2024-01-12 23:15:00', 5, '待处理', '李四');
...
(1102, 1, '2024-2025-1', 76.00, 3.15, 74.50, '二星', '星级寝室', '已发布'),
(1103, 1, '2024-2025-1', 64.00, 2.85, 62.50, '无星', '星级寝室', '已发布');